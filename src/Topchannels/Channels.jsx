...
const Channels = () => {
  ...
  return (
    <div className="p-10 bg-white min-h-screen lg:mx-2 md:mx-6 mx-4 dark:bg-gray-700">
        ...
        <button onClick={() => handleChannel('revenues')} className={`py-2 px-1 text-white rounded transition-all duration-500 ease-in-out transform ${currentChannel === 'revenues' ? 'bg-blue-600 border-t-4 border-blue-600 scale-105' : 'bg-gray-800'}`}>RVENUES</button>
