            ...
            <table>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap dark:text-white">560</td>
                        <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <tr>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap dark:text-white">9.1K</td>
                        <td className="px-6 py-4 whitespace-nowrap text-green-600">$6,708</td>
                        <td className="px-6 py-4 whitespace-nowrap dark:text-white">980</td>
                        <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <tr>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap dark:text-white">5.9K</td>
                        <td className="px-6 py-4 whitespace-nowrap text-green-600">$8,768</td>
